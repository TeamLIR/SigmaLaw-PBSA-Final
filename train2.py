...
#from data_utils import Tokenizer4Bert, build_tokenizer, ABSADataset
from data_utils_asgcn import build_embedding_matrix,Tokenizer4Bert, build_tokenizer, ABSADataset
from models.sdgcn import SDGCN
from models.sdgcn_new import SDGCN_NEW
...
class Instructor:
    def __init__(self, opt):
        ...
        self.trainset = ABSADataset(opt.dataset_file['train'], './datasets/semeval14/law_train.raw.graph', tokenizer)
        self.testset = ABSADataset(opt.dataset_file['test'],'./datasets/semeval14/law_train.raw.graph',  tokenizer)
...
def main():
    ...
    parser.add_argument('--model_name', default='gcn_bert', type=str)
    ...
    input_colses = {
        ...
        'gcn_bert': ['text_raw_bert_indices', 'aspect_bert_indices', 'dependency_graph','text_left_indices'],
        'gcn_bert_new': ['text_raw_bert_indices', 'aspect_bert_indices', 'x_len','target_len'],
